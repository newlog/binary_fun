...
class PEOptionalHeaderUtils(object):
    ...
    def _translate_characteristics(value):
        is_dll = 'DLL: True' if value & 0x2000 else 'DLL: False'
        is_32bit = '32-bit: True' if value & 0x0100 else '32-bit: False'
        is_16bit = '16-bit: True' if value & 0x0040 else '16-bit: False'
        is_stripped = 'Stripped: True' if value & 0x0200 else 'Stripped: False'
